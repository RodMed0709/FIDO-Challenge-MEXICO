...
# (analysis/verify_task1_distance_geometry.py, peldaño T1-R2).
DISTANCE_SCALE_A = 0.7320
DISTANCE_SCALE_B = 2.6779

# Mejor constante posible para la distancia cuando no hay OCT o la segmentación
# no produce una medición: da distance_auc=0.0445 sobre los 61,691 casos, que es
# el piso trivial conocido. Cualquier otro valor es estrictamente peor.
