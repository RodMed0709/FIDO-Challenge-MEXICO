...
# Reescalado x1.28 igual que A y B (2026-08-19). El valor viejo (159.2) era la
# constante optima medida sobre los 61,691 casos CONTRA EL TARGET VIEJO (GT/10),
# donde daba el piso trivial distance_auc=0.0445. Como el target real es ahora
# GT/7.8125, es decir 1.28x mayor, la constante optima escala por el mismo factor.
# Dejarla en 159.2 la situa 45.6 px por debajo del centro de la distribucion, muy
# por encima del umbral maximo de 20 px: cada caso que cae en el fallback puntua
# cero garantizado. Afecta al ~10% sin OCT MAS los casos donde la segmentacion no
# logra medir el gap.
DISTANCE_FALLBACK_PX = 203.8  # 159.2 * 1.28
