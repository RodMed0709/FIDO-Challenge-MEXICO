...
A one-person entry, run as personal research.
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="docs/figures_public/02-score-decomposition-dark.png">
  <img alt="Task 1 score decomposed into keypoint and distance components for r01, r06 and the leader" src="docs/figures_public/02-score-decomposition-light.png">
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="docs/figures_public/05-task2-geometry-dark.svg">
  <img alt="Schematic of the Task 2 geometry: the iOCT unit square mapped onto microscope pixels by a reflected similarity" src="docs/figures_public/05-task2-geometry-light.svg">
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="docs/figures_public/01-distance-rescale-dark.png">
  <img alt="The fitted distance relation before and after rescaling, showing 17.3 px of systematic bias" src="docs/figures_public/01-distance-rescale-light.png">
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="docs/figures_public/04-scale-augmentation-dark.png">
  <img alt="Baseline versus scale-augmented: corner AUC, mean corner error and scale MAE" src="docs/figures_public/04-scale-augmentation-light.png">
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="docs/figures_public/03-tta-collapse-dark.png">
  <img alt="Keypoint AUC across six TTA and ensemble variants; flips and rotations collapse it to 0.0061" src="docs/figures_public/03-tta-collapse-light.png">
</picture>
...
Every figure in this README is generated by
[`analysis/render_public_figures.py`](analysis/render_public_figures.py) from the
numbers recorded in this repository. **None of them contains a single pixel of
challenge data** — the dataset is CC BY-NC-ND, so qualitative panels showing real
frames are deliberately absent.
...
**Rodrigo Medellín** — sole author. Everything in this repository is personal
research, run independently of any employer or institution.
